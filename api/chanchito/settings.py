...
# Esto configura la STATIC_URL cuando esta en distribucion

import os
_PROJECT_DIR = os.path.dirname(os.path.dirname(__file__))
_API = '/' + _PROJECT_DIR.split('/')[-2] + '/api/'

STATIC_URL = _API + STATIC_ROOT 
...
SECRET_KEY = '_n97d_8--1*oxd5afe%hniefvc915zg5qz)g=&v1wuwm9&t59k'
